...
Все тесты использовали встроенный навык `pptx` от Anthropic. Он активируется автоматически в Claude Code при работе с .pptx файлами — отдельная установка не требуется. При использовании других агентов можно установить так:
```bash
